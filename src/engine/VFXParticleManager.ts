	...
	private registerEffects(): void {
		...
		this.effects.set("copperSplash", () => {
			...
			emitter.addInitialize(
				new Velocity(new Span(80, 180), new Span(0, 360), "polar"),
			);
		...
		this.effects.set("bellSoundwave", () => {
			...
			emitter.addInitialize(
				new Velocity(new Span(100, 220), new Span(0, 360), "polar"),
			);
		...
		this.effects.set("towerEmbers", () => {
			...
			emitter.addInitialize(
				new Velocity(new Span(20, 60), new Span(250, 290), "polar"),
			);
		...
		this.effects.set("mirrorShards", () => {
			...
			emitter.addInitialize(
				new Velocity(new Span(120, 300), new Span(0, 360), "polar"),
			);
		...
		this.effects.set("peonyPetals", () => {
			...
			emitter.addInitialize(
				new Velocity(new Span(10, 40), new Span(160, 200), "polar"),
			);
